...
description: This is a HTB Season 6 (Aug-Nov 2024) Machine in Medium Category. This machine involves decompiling an apk file and understanding how API works. The root flag also involves SolarPutty session cracking.
categories:
 - Writeup
tags:
- htb
...
![Enum1](/assets/images/htb-instant-2024/enum1.png)

There are two open ports.
- **Port 22 (ssh)**
- **Port 80 (http)**
## Web Enumeration
Firstly, we need to add **instant.htb** to our **/etc/hosts**. Then we can open **http://instant.htb** in the browser.

![Enum2](/assets/images/htb-instant-2024/enum2.png)
...
## APK File
![Enum3](/assets/images/htb-instant-2024/enum3.png)

After decompiling we will get two folders:
- **resources**
- **sources**

After going through the folders, we can see that the source code is not obfuscated. There are multiple interesting files at **sources/com/instantlabs/instant**

![Enum4](/assets/images/htb-instant-2024/enum4.png)
...
![Enum5](/assets/images/htb-instant-2024/enum5.png)
...
![Enum6](/assets/images/htb-instant-2024/enum6.png)
...
![Enum7](/assets/images/htb-instant-2024/enum7.png)
...
![Exploit1](/assets/images/htb-instant-2024/exploit1.png)

Now that we are authorized, we can check every API, starting with **/api/v1/admin/list/users** to list out user.
![Exploit2](/assets/images/htb-instant-2024/exploit2.png)
...
![User-Flag](/assets/images/htb-instant-2024/user-flag.png)
...
![Exploit5](/assets/images/htb-instant-2024/exploit5.png)
...
![Exploit6](/assets/images/htb-instant-2024/exploit6.png)
...
![PrivEsc1](/assets/images/htb-instant-2024/privesc1.png)
...
![PrivEsc2](/assets/images/htb-instant-2024/privesc2.png)
...
![PrivEsc3](/assets/images/htb-instant-2024/privesc3.png)
...
![PrivEsc4](/assets/images/htb-instant-2024/privesc4.png)
...
![Root-Flag](/assets/images/htb-instant-2024/root-flag.png)

GGWP

![Pwned](/assets/images/htb-instant-2024/pwned.png)
